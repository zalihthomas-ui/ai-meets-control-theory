...
Reference data: [`docs/references/cartpole-lqr-reference.md`](../../docs/references/cartpole-lqr-reference.md).
Theory: modules [04](../../modules/04-modern-control) and [05](../../modules/05-optimal-control).
