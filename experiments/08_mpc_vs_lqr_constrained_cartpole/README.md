...
Companion theory:
[`modules/05-optimal-control/05-model-predictive-control-intro.md`](../../modules/05-optimal-control/05-model-predictive-control-intro.md).
...
![cart position + angle + force](cart_constraint.png)
