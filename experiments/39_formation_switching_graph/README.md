...
Companion theory: [docs/references/multi-agent-formation-reference.md](../../docs/references/multi-agent-formation-reference.md).
...
```
   Phase 1: Complete Mesh (K5)        Phase 2: Ring (C5)          Phase 5: Star Hub (S5)
             ( 1 )                          ( 1 )                          ( 1 )
            / | \ \                        /     \                        / | \ \
           /  |  \ \                      /       \                      /  |  \ \
         (2)-(3)-(4)-(5)                (2)       (5)                  (2) (3) (4) (5)
...
Benchmark evaluated on a 5-agent double-integrator team (`MultiAgentSystem`):
...
![Multi-Agent Formation Tracking under Switching Topologies](formation_switching.png)
