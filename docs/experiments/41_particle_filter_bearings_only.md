...
Companion theory: [docs/references/particle-filter-reference.md](../references/particle-filter-reference.md).
...
![Bearings-Only Target Tracking Comparison](figures/exp41_pf_vs_ekf.png)
