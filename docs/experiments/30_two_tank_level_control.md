...
The system dynamics are derived in [`docs/references/two-tank-reference.md`](../references/two-tank-reference.md):
...
![Experiment 30 — Two Tank Benchmark](figures/exp30_two_tank_benchmark.png)
*Experiment 30 — Two Tank Benchmark*


![Experiment 30 — Two Tank Benchmark](figures/exp30_two_tank_benchmark.svg)
*Experiment 30 — Two Tank Benchmark*


![Experiment 30 — Two Tank Setpoint](figures/exp30_two_tank_setpoint.png)
*Experiment 30 — Two Tank Setpoint*


![Experiment 30 — Two Tank Setpoint](figures/exp30_two_tank_setpoint.svg)
*Experiment 30 — Two Tank Setpoint*
