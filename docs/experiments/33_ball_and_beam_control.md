...
The analytical equations of motion are derived via Euler-Lagrange mechanics in [`docs/references/ball-and-beam-reference.md`](../references/ball-and-beam-reference.md):
...
![Experiment 33 — Ball And Beam Benchmark](figures/exp33_ball_and_beam_benchmark.png)
*Experiment 33 — Ball And Beam Benchmark*


![Experiment 33 — Ball And Beam Benchmark](figures/exp33_ball_and_beam_benchmark.svg)
*Experiment 33 — Ball And Beam Benchmark*


![Experiment 33 — Ball And Beam Setpoint](figures/exp33_ball_and_beam_setpoint.png)
*Experiment 33 — Ball And Beam Setpoint*


![Experiment 33 — Ball And Beam Setpoint](figures/exp33_ball_and_beam_setpoint.svg)
*Experiment 33 — Ball And Beam Setpoint*
