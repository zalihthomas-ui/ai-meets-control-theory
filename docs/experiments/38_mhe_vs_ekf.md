...
Companion theory: [docs/references/mhe-reference.md](../references/mhe-reference.md).
...
Benchmark evaluated on `aimct.systems.TwoTank` ($A_1=A_2=1.555\times 10^{-3}\text{ m}^2, a_{12}=a_2=1.81\times 10^{-5}\text{ m}^2$):
...
![MHE vs EKF on Coupled Two-Tank](figures/exp38_mhe_vs_ekf.png)
