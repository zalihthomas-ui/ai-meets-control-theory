...
Companion: [`src/aimct/benchmarks/challenge.py`
...
![ICC leaderboard](figures/exp19_figure.png)
...
Composite score / 100 (status). Every submission sees only the ICC spec, never the plant.
