...
Companion: [`aimct.systems.TwoLinkArm`,
...
![Part A — nominal](figures/exp23_tracking.png)
...
![Part B — payload mismatch](figures/exp23_payload.png)
...
# Exp 23A - two-link arm joint tracking (nominal)

| controller | rms_err_mm | max_err_mm | rms_cross_track_mm | completion_pct | ctrl_energy | status |
| --- | --- | --- | --- | --- | --- | --- |
| PD + gravity comp | 32.24 | 54.47 | 21.43 | 99.38 | 891.2 | OK |
| Computed torque | 4.322 | 29.59 | 3.37 | 100 | 164.3 | OK |
| Joint LQR | 2.572 | 12.02 | 4.143 | 100 | 164.5 | OK |
| Joint MPC | 9.999 | 50.5 | 3.383 | 100 | 164.4 | OK |
