...
![HIL Arm Balance Trajectories](figures/exp36_hil_arm_balance.png)

### Delay Margin vs. Closed-Loop Stability Boundary
![Delay Margin Boundary](figures/exp36_hil_delay_margin.png)
...
![Experiment 36 — Hil Arm Balance](figures/exp36_hil_arm_balance.svg)
*Experiment 36 — Hil Arm Balance*


![Experiment 36 — Hil Delay Margin](figures/exp36_hil_delay_margin.svg)
*Experiment 36 — Hil Delay Margin*
